        ...
        <footer className="container mx-auto px-4">
            <div className="flex justify-between">
                <div className="w-1/6">
                    ...
                    <ul className="mt-4">
                        <li className="mt-2">
                            <Link href=""><a className="text-indigo-600 hover:text-teal-500 hover:underline">API Developer</a></Link>
                        </li>
                        <li className="mt-2">
                ...
                <div className='w-1/6'>
                    ...
                    <ul className="mt-4">
                        ...
                        <li className="mt-2">
                            <Link href=""><a className="text-indigo-600 hover:text-teal-500 hover:underline">Our Pathskills</a></Link>
                        </li>
                        <li className="mt-2">
                            <Link href=""><a className="text-indigo-600 hover:text-teal-500 hover:underline">All Features</a></Link>
                        </li>
                        <li className="mt-2">
                ...
                <h6 className="text-white">Promotions</h6>
                    ...
                    <form onSubmit={submit}>
                        <input type="text" className="bg-white focus:outline-none border-0 px-6 py-3 mt-6" placeholder="Enter Email Address" />
                        <button className="bg-orange-500 hover:bg-orange-400 transition-all duration-200 focus:outline-none shadow-inner text-white px-6 py-3">Daftar</button>
                    </form>
                </div>
            </div>
            <div className="border-t pt-8 mt-8 border-gray-800 text-center">
                <p className="text-indigo-500">2020 Copyright Micro by BuildWith Angga. All Right Reserved</p>
            </div>
        </footer>
    );
}
